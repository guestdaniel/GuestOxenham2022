...
f, axs = plt.subplots(2, 2, figsize=(7, 4), sharex=True)
...
plot_ep(axs[0, 1], 280, 'ISO', 50, 40, '280 Hz', True, '#fc8d62', fiber_type='lsr')
plot_ep(axs[0, 1], 280, 'GEOM', 50, 40, '280 Hz', True, '#8da0cb', fiber_type='lsr')
plot_ep(axs[1, 1], 1400, 'ISO', 50, 40, '1400 Hz', False, '#fc8d62', fiber_type='lsr')
plot_ep(axs[1, 1], 1400, 'GEOM', 50, 40, '1400 Hz', False, '#8da0cb', fiber_type='lsr')
