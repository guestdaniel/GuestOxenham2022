...
├── ...  
├── figure4                  # Code for Figure 6
│   ├── figure4a.py          # Python code to generate run simulations featured in Figure 6
│   ├── figure4a.R           # R code to plot results from figure4.py
│   ├── *.csv                # Results generated by figure4.py
│   └── ...      
├── figure7                  # Code for Figure 6, similar in structure to /figure4
