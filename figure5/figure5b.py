...
def simulate_figure4_fdls_phase_roving(model, model_name, fs, n_rep=10):
    ...
    the results to disk. Includes simulations of phase roving and for level roving.
    ...
    params = si.increment_parameters(params, {'(1)_phase': np.array([0.001, 0, 0, 0, 0]),   # increment phase of H6
